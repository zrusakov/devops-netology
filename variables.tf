...
variable "vms_ssh_root_key" {
  type        = string
  default     = "ubuntu:ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAINiFCb8W4biGF2NZpeR3gAy18yOBfpL0uozhmngmWDdu vagrant@server1"
...
variable "ssh_public_key" {
  type        = string
  default     = "/home/vagrant/.ssh/id_ed25519.pub"
